...
select leads.visit_page_month as "mês",
	   ...
	   ROUND(payments.receita/1000, 6) as "receita(k, R$)",
	   payments.paid_count::float/leads.visit_page_count::float as "conversão(%)",
	   ROUND(payments.receita/payments.paid_count/1000, 6) as "ticket médio (k, R$)"
...
from sales.funnel as fun
left join sales.products as pdt
	on fun.product_id = pdt.product_id
where paid_date between '2021-08-01' and '2021-08-31'
...
select paid_date from sales.funnel
